        ...
        <tr>
            <td  style="padding: 40px 30px 40px 30px;">
               <table cellpadding="0" cellspacing="0" width="100%">
                   <tr>
                        <td>
                            <p style="font-family: 'Open Sans', sans-serif;color: rgb(92, 86, 86); font-weight: bold;font-size: 20px;">Prezado(a) {{ $NomeAluno }},</p>
                        </td>
                   </tr>
                   <tr>
                        <td>
                            <p style="font-family: 'Open Sans', sans-serif;color: rgb(92, 86, 86);font-weight: 300; font-size: 19px;">Recebemos a sua solicitação (ID {{ $id }}) e em breve entraremos em contato.</p>
                        </td>
                   </tr>
                   <tr>
                       <td style="padding-bottom:2%">
                           <p style="font-family: 'Open Sans', sans-serif;color: rgb(92, 86, 86);font-weight: 300; font-size: 19px;">Obrigado!</p>
                       </td>
                   </tr>
               </table>
            </td>
